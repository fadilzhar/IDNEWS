        ...
        <form action="{{ route('post.store')}}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 gap-6">
            ...
            <div>
                <label class="form-control w-full max-w-xs">
                    ...
                    <textarea type="text" id="description" name="description" class="input input-bordered w-full max-w-xs"></textarea>
                  </label>
            </div>
            ...
            <div>
                <label class="form-control w-full max-w-xs">
                    ...
                    <textarea type="text" id="content" name="content" class="input input-bordered w-full max-w-xs"> </textarea>
                  </label>
            </div>
